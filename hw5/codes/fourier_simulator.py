...
height = 128
width = 128
intv = 4 # Interval for downsampling the frequency and spatial temporal variables
...
edited_spatial_temporal_signal = xformer.fast_idft(shifted_frequency_signal)
